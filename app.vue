  ...
  <UContainer as="main">
    <div class="h-dvh">
      <HBox class="h-full w-full">
        <CBox class="h-full w-full">
          <VBox>
            <h2 class="text-3xl font-medium my-6">Лучшее окрашивание в блонд</h2>
    ...
    <div class="h-dvh" id="price">
      <VBox>
        ...
        <p class="mb-4">— Цены одинаковы для всех оттенков(Тотал блонд / Стальной / т.д.).</p>
        <VBox class="mt-12 ">
          <HBox class="mb-1">
            <ButtonTG/>
            <ButtonW class="ml-2"/>
      ...
      <VBox>
        ...
        <UButton
          ...
          <HBox class="gap-1">
            ...
            <NuxtImg src="img/salon 2.jpg" alt="фото салона" height="400px" width="min-content" />
          </HBox>
      </VBox>
    </div>
